...
public class Runner {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		action.longPress(new LongPressOptions().withElement(new ElementOption().withElement(source))).moveTo(new PointOption().
				withCoordinates(destination.getLocation().getX(), destination.getLocation().getY())).release().perform();
